...
window.load = function () {
	...
	var running = false;
	var moveBy = new MoveByAction({ time: 200, position: { x: 10 }, onComplete: function onComplete(val) {
			running = false;
		} });
	...
	var layer = new Layer({ zIndex: -1, anchor: { x: 0.5, y: 0.5 }, position: { x: 200, y: 200 }, width: 200, height: 200 });
	// layer.scale.x=2;
	// layer.rotate=45;
	...
	var text = new Text({ text: "hello world", fontSize: 50, textAlign: "right", textBaseline: "bottom" });
