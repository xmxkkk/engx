...
window.load = function () {
    ...
    scene.addResource([{
        name: 'meinv',
        url: 'https://img6.bdstatic.com/img/image/smallpic/xiaoqingxin112.jpg',
        type: 'image'
    }, {
        name: 'meinv2',
        url: 'http://img6.bdstatic.com/img/image/smallpic/chongwu112.jpeg',
        type: 'image'
    },
    // {name:'bgmusic',url:"./resource/audio/music.mp3",type:"audio"},
    {
        ...
        name: 'animate',
        url: "./resource/img/F3_CHA41.png",
        type: "image"
    }, {
        name: "bg",
        url: './resource/img/bg.jpg',
        type: "image"
    }, {
        name: 'boom',
    ...
    mm.mousemove(function (event) {
        if (mm.grab) {
            var dx = event.layerX - mm.grabEvent.layerX + mm.grabStartPosition.x;
            var dy = event.layerY - mm.grabEvent.layerY + mm.grabStartPosition.y;
    ...
    mm.mouseup(function (event) {
        mm.grab = false;
        var scaleTo = new RotateByAction({
            time: 10000,
    ...
    window.runAction = function () {
        var moveTo = new MoveByAction({
            ...
            delay: 0,
            onComplete: function onComplete(prop) {
                log(prop);
            },
